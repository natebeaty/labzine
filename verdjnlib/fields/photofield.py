...
# Commented out -- No longer changing filenames
...
class PhotoField(ImageField):
    ...
    def __init__(self, verbose_name=None, name=None, width_field=None, height_field=None,
        width=DEFAULT_WIDTH, height=DEFAULT_HEIGHT, mode=DEFAULT_MODE, quality=None, copy_fields=[],
        **kwargs):
    ...
    #    #print "_update_parent_pk invoked"
    ...
    def save_file(self, new_data, new_object, original_object, change, rel, save=True):
        ...
        if len(field_names) < 3 or not new_data.get(field_names[2], False):
            if new_data.get(upload_field_name, False):
                ...
                #    os.remove(filepath)
        super(PhotoField, self).save_file(new_data, new_object, original_object, change, rel, save)
